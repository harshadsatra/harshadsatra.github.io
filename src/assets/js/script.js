...
;(function ($) {
	...
	$olMenuToggleBtn.on("click", function () {
		...
		if ($("body").hasClass("tt-ol-menu-open")) {
			...
			tl_olMenuIn.to(".tt-ol-menu-bottom", { duration: 0.4, autoAlpha: 1 })
			...
			tl_olMenuOut.to(".tt-ol-menu-bottom", { duration: 0.4, autoAlpha: 0 })
	...
	$(".portfolio-interactive-item").each(function () {
		var $piItem = $(this)
		$piItem.find(".pi-item-title-link")
			.on("mouseenter", function () {
				// hover title
